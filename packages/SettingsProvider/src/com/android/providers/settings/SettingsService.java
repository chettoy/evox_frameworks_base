    ...
    final static class MyShellCommand extends ShellCommand {
        ...
        static void dumpHelp(PrintWriter pw, boolean dumping) {
            if (dumping) {
                ...
                pw.println("  get [--user <USER_ID> | current] [--lineage] [--deviceId <DEVICE_ID> | 0]"
                        + " NAMESPACE KEY");
                pw.println("      Retrieve the current value of KEY.");
                pw.println("  put [--user <USER_ID> | current] [--lineage] [--deviceId <DEVICE_ID> | 0]"
                ...
                pw.println("  delete [--user <USER_ID> | current] [--lineage] [--deviceId <DEVICE_ID> | 0]"
                        + " NAMESPACE KEY");
                pw.println("      Delete the entry for KEY.");
                pw.println("  reset [--user <USER_ID> | current] [--lineage] [--deviceId <DEVICE_ID> | 0]"
